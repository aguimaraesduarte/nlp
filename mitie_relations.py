...
print 'Detection score for Knox being acquitted:', rel_detector(ner.extract_binary_relation(test_sentence, xrange(4, 8), xrange(10, 12)))

# Now let's test this with a different phrasing
